...
__fish_brew_complete_arg 'bundle' -l cargo -d '`list` or `dump` Cargo packages'
...
__fish_brew_complete_arg 'test-bot' -l skip-recursive-dependents -d 'Only test the direct dependents'
